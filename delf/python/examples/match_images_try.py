...
def main(unused_argv):
  ...
  locations_1 = locations_1[attention_1 < 60, :]
  descriptors_1 = descriptors_1[attention_1 < 60, :]
  ...
  locations_2 = locations_2[attention_2 < 60, :]
  descriptors_2 = descriptors_2[attention_2 < 60, :]
